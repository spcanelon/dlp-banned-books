...
- Pick a state in the `data` folder that you'd like to tackle and add a file like `clean_state_name.py` to the `etl` folder. Feel free to use whichever coding language you're most comfortable with to extract the data. If the data is a PDF, you may want to try some of [the table extraction tools on DocumentCloud](https://www.documentcloud.org/add-ons/MuckRock/azure-table-extractor/). If you haven't used DocumentCloud, you can join MuckRock's DLP organization on MuckRock and DocumentCloud by asking in the Slack channel. 
